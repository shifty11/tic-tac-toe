...
type SystemInfo struct {
	NextGameId uint64 `protobuf:"varint,1,opt,name=nextGameId,proto3" json:"nextGameId,omitempty"`
}
...
func (m *SystemInfo) GetNextGameId() uint64 {
	if m != nil {
		return m.NextGameId
	}
	return 0
...
func init() {
	proto.RegisterType((*SystemInfo)(nil), "shifty11.tictactoe.tictactoe.SystemInfo")
}
...
var fileDescriptor_6de8a7815ad8f095 = []byte{
	...
	,
}
...
func (m *SystemInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.NextGameId != 0 {
		i = encodeVarintSystemInfo(dAtA, i, uint64(m.NextGameId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *SystemInfo) Size() (n int) {
	...
	_ = l
	if m.NextGameId != 0 {
		n += 1 + sovSystemInfo(uint64(m.NextGameId))
	}
	return n
}
